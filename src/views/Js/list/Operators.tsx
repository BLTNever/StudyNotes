...
const Operator = () => (
  <>
    <Wrap>
      <Typography.Title level={2}>运算符</Typography.Title>
      <Typography.Text type="secondary">加、减、乘、除、取模</Typography.Text>
      <Collapse defaultActiveKey="" ghost>
        <Panel header="加性运算符 + " key="1">
          <Space direction="vertical">
            ...
            <Text mark>
              **加号后面跟一个操作元,叫 Unary + Operator ,会将操作元转换为
              Number 形式
            </Text>
            <Text>
              对于undefined和null,则分别调用String()函数并取得字符串“undefined”
              和“null”
            </Text>
          </Space>
        </Panel>
        ...
        <Panel header="系数(取模)运算符 % " key="5">
          取余数
        </Panel>
        <Panel header="取幂运算符 **  " key="7">
          x ** n 等同于 Math.pow(x, n),即 x 的 n 次方
        </Panel>
    ...
    <Wrap>
      <Typography.Title level={2}>i++ & ++i</Typography.Title>
      <Collapse defaultActiveKey="" ghost>
    ...
    <Wrap>
      <Typography.Title level={2}>位运算</Typography.Title>
      <Collapse defaultActiveKey="" ghost>
        <Panel header="左移运算<<和右移运算>>" key="1">
          <Space direction="vertical">
            <Text mark>
              左移运算{"<<"}: 简洁记法——乘({"例: 4 << 3 4乘2的3次方,向下取整"})
            </Text>
            <Text>
              左移运算: 把数字中的所有数位向左移动指定的数量。例如,把数字
              2(等于二进制中的 10)左移 5 位,结果为 64(等于二进制中的 1000000)
            </Text>
            <Text mark>
              右移运算{">>"}: 简洁记法——除({"例: 4 >> 3 4除2的3次方,向下取整"})
            </Text>
            <Text>
              {" "}
              右移运算:
              把32位数字中的所有数位整体右移,同时保留该数的符号(正号或负号)。有符号右移运算符恰好与左移运算相反。例如,把64右移5位,将变为2
            </Text>
          </Space>
        </Panel>
        ...
        <Panel header="位或(|)" key="3">
          <Space direction="vertical">
            ...
            <pre>1001 | 1010 ------- 1011</pre>
            <Text>
              整数与0的位或运算,都是本身。浮点数不支持位运算,过程中会自动转化成整数,利用这一点,可以将浮点数与0进行位或运算即可达到取整目的。console
            </Text>
            <code>console.log(15.22 | 0); // 15</code>
          </Space>
        </Panel>
        ...
        <Panel header="异或(^)" key="5">
          <Space direction="vertical">
            ...
            <pre>1001 | 1010 ------- 0011</pre>
            <Text>可以用于交换两个整数的值,不过一般很少这么用</Text>
            <code>
              var a = 3, b = 5; a ^= b; b ^= a; a ^= b; console.log(a, b); // 5
              3
            </code>
          </Space>
        </Panel>
