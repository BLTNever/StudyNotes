...
const AlgoDp = () => {
    ...
    return (
        <>
            ...
            <Wrap id="climbStairs">
                <Title level={3}>70.爬楼梯（easy）{T.DP}</Title>
                <Collapse ghost>
            ...
            <Wrap id="fib1">
                <Title level={3}>509.斐波那契数（easy）{T.DP}</Title>
                <Collapse ghost>
            ...
            <Wrap>
                <Title level={3}>746.使用最小花费爬楼梯（easy）{T.DP}</Title>
                <Collapse ghost>
            ...
            <Wrap>
                <Title level={3}>剑指 Offer 10- I.斐波那契数列（easy）{T.DP}</Title>
                <Collapse ghost>
            ...
            <Wrap>
                <Title level={3}>剑指 Offer 10- II.青蛙跳台阶问题（easy）</Title>
                <Collapse ghost>
