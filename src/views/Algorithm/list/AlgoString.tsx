...
const AlgoString = () => {
    ...
    return (
        <>
            ...
            <Wrap>
                <Title level={3}>28.实现 strStr()</Title>
                <Collapse ghost>
            ...
            <Wrap>
                <Title level={3}>2843.最后一个单词的长度</Title>
                <Collapse ghost>
            ...
            <Wrap>
                <Title level={3}>1945.字符串转化后的各位数字之和</Title>
                <Collapse ghost>
            ...
            <Wrap>
                <Title level={3}>1957.删除字符使字符串变好</Title>
                <Collapse ghost>
            ...
            <Wrap>
                <Title level={3}>1961.检查字符串是否为数组前缀</Title>
                <Collapse ghost>
            ...
            <Wrap>
                <Title level={3}>1974.作为子字符串出现在单词中的字符串数目</Title>
                <Collapse ghost>
            ...
            <Wrap>
                <Title level={3}>使用特殊打字机键入单词的最少时间</Title>
                <Collapse ghost>
            ...
            <Wrap>
                <Title level={3}>2000.反转单词前缀</Title>
                <Collapse ghost>
            ...
            <Wrap>
                <Title level={3}>2027. 转换字符串的最少操作次数</Title>
                <Collapse ghost>
            ...
            <Wrap>
                <Title level={3}>2042.检查句子中的数字是否递增</Title>
                <Collapse ghost>
            ...
            <Wrap>
                <Title level={3}>2047.句子中的有效单词数</Title>
                <Collapse ghost>
            ...
            <Wrap>
                <Title level={3}>2062. 统计字符串中的元音子字符串</Title>
                <Collapse ghost>
            ...
            <Wrap>
                <Title level={3}>2068. 检查两个字符串是否几乎相等</Title>
                <Collapse ghost>
            ...
            <Wrap>
                <Title level={3}>剑指 Offer 05. 替换空格</Title>
                <Collapse ghost>
