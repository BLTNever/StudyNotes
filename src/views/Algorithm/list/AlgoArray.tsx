...
const AlgoArray = () => {
    ...
    return (
        <>
            ...
            <Wrap>
                <Title level={3}>88.合并两个有序数组（easy）</Title>
                <Collapse ghost>
            ...
            <Wrap>
                <Title level={3}>26.删除有序数组中的重复项I（easy）</Title>
                <Collapse ghost>
            ...
            <Wrap>
                <Title level={3}>27.移除元素（easy）</Title>
                <Collapse ghost>
            ...
            <Wrap>
                <Title level={3}>35.搜索插入位置（easy）</Title>
                <Collapse ghost>
            ...
            <Wrap>
                <Title level={3}>1995.统计特殊四元组（easy）</Title>
                <Collapse ghost>
            ...
            <Wrap>
                <Title level={3}>2006.差的绝对值为 K 的数对数目（easy）</Title>
                <Collapse ghost>
            ...
            <Wrap>
                <Title level={3}>2011.执行操作后的变量值（easy）</Title>
                <Collapse ghost>
            ...
            <Wrap>
                <Title level={3}>2016.增量元素之间的最大差值（easy）</Title>
                <Collapse ghost>
