...
const Interview1 = () => (
    <>
            ...
            <Collapse ghost>
                <Panel header="" key="1">
                    <Space direction="vertical">
                        ...
                        <ul>
                            <li> <Text>减少页面请求文件的体积、减少接口请求的数量，延时请求加载</Text></li>
                            ...
                            <li><Text>函数防抖（debounce）、函数节流（throttle）</Text></li>
        ...
        <Wrap>
            <Title level={3}>3. React事件机制</Title>
            <Collapse ghost>
                <Panel header="" key="1">
                    <Space direction="vertical">
        ...
        <Wrap>
            <Title level={3}>5. React 优化</Title>
            <Collapse ghost>
                <Panel header="" key="1">
                    <Space direction="vertical">
