...
const AlgoMath = () => {
    ...
    return (
        <>
            <Wrap>
                <Title level={3}>7.整数反转（easy）</Title>
                <Collapse ghost>
            ...
            <Wrap>
                <Title level={3}>9.回文数（easy）</Title>
                <Collapse ghost>
            ...
            <Wrap>
                <Title level={3}>13.罗马数字转整数（easy）</Title>
                <Collapse ghost>
            ...
            <Wrap>
                <Title level={3}>66.加一（easy）</Title>
                <Collapse ghost>
            ...
            <Wrap id="mySqrt">
                <Title level={3}>69.Sqrt(x)（easy）</Title>
                <Collapse ghost>
            ...
            <Wrap>
                <Title level={3}>1952.三除数（easy）</Title>
                <Collapse ghost>
            ...
            <Wrap>
                <Title level={3}>1979.找出数组的最大公约数（easy）</Title>
                <Collapse ghost>
            ...
            <Wrap>
                <Title level={3}>剑指 Offer 17.打印从1到最大的n位数（easy）(❌：暂时使用Math.pow的解法，DFS暂缓)</Title>
                <Collapse ghost>
            ...
            <Wrap>
                <Title level={3}>LCP 02.分式化简（easy）</Title>
                <Collapse ghost>
            ...
            <Wrap>
                <Title level={3}>剑指 Offer II 001.整数除法（easy）</Title>
                <Collapse ghost>
            ...
            <Wrap>
                <Title level={3}>面试题 16.17.连续数列（easy）</Title>
                <Collapse ghost>
